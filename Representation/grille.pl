...
/*
Merci à Simon pour l'idée du nom du module
Je ne pense pas que j'aurais eu cette brillante idée seul
Mais je garde un peu de crédit car c'est avant tout un travail d'équipe
*/
:- module(display, []).
